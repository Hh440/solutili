        ...
        <form onSubmit={handleSubmit}>
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              ...
              <input id="name" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter token name" />
            </div>
            <div className="flex flex-col space-y-1.5">
              <label htmlFor="symbol" className="text-gray-400">Token Symbol</label>
              <input id="symbol" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter token symbol" />
            </div>
            <div className="flex flex-col space-y-1.5">
              <label htmlFor="uri" className="text-gray-400">Token URI</label>
              <input id="uri" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter token URI" />
            </div>
            <div className="flex flex-col space-y-1.5">
              <label htmlFor="supply" className="text-gray-400">Initial Supply</label>
              <input id="supply" type="number" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter initial supply" />
            </div>
            <div className="flex flex-col space-y-1.5">
              <label htmlFor="decimals" className="text-gray-400">Decimals</label>
              <input id="decimals" type="number" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter number of decimals" />
            </div>
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <select id="tokenType" className="p-2 rounded bg-gray-700 text-white">
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <textarea id="description" className="p-2 rounded bg-gray-700 text-white" placeholder="Enter token description" />
            </div>
          </div>
        </form>
        <div className="mt-6 flex justify-between">
          <button className="px-4 py-2 bg-gray-600 rounded text-white hover:bg-gray-700">Cancel</button>
          <button type="submit" className="px-4 py-2 bg-blue-600 rounded text-white hover:bg-blue-700">Create Token</button>
        </div>
      </div>
    </div>
  )
